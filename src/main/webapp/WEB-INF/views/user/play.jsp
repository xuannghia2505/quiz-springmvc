...
<body>
	<div id="backgroundPlay">
		<div class="container">
			...
			<c:forEach items="${listQuestions}" var="question" varStatus="index">
				<div id="question-container${index.index}" class="hide">
					<div style="color:red; font-size:30px;">Câu hỏi số ${index.index+1}</div>
					...
					<c:if test="${question.audio!=null }">
						<audio src="/assets/audio/${question.audio }"
							style="margin-top: 50px;" controls></audio>
						<div class="answer-buttons" class="btn-grid"
							style="margin-top: 30px;">
							<img class="btn2" onclick="selectAnswer('A')"
								src="${question.answerA}" width="300px" height="200px" style="cursor:pointer;"></img> <img
								class="btn2" onclick="selectAnswer('B')"
								src="${question.answerB}" width="300px" height="200px" style="cursor:pointer;"></img> <br />
							<img class="btn2" onclick="selectAnswer('C')"
								src="${question.answerC}" width="300px" height="200px" style="cursor:pointer;"></img> <img
								class="btn2" onclick="selectAnswer('D')"
								src="${question.answerD}" width="300px" height="200px" style="cursor:pointer;"></img>
						</div>
					</c:if>
					<c:if test="${question.answerA==null }">
						<div id="questionEnglish${index.index }" class="question" value="${question.question }">${question.question }</div>
			...
			<div class="hide" id="controlTalk">
			<div class="hide" style="font-size:25px; font-weight:700px; margin-top:-30px;" id="hearing"> Đang lắng nghe...</div>
			...
			<div id="tableResult" class="hide">
				<form action="hoanthanh" method="post">
					...
					<div>
						<button class="backhome" type="submit" style="cursor:pointer;">Hoàn thành bài thi</button>
					</div>
	 ...
	 <div class="alert hide" id="alertC1">
         ...
         <span id="msgCorrect1">bạn trả lời gần đúng rồi nè</span>
	 ...
	 <div class="alert hide" id="alertC2">
      ...
      <div class="alert hide" id="alertW">
         <span class="fas fa-exclamation-circle"></span>
          ...
          <span  id="msgWrong">sai mất tiêu rùii, cố gắng lần sau nha</span>
         <div class="close-btn">
            <span style="color:white; font-size:22px;">X</span>
         </div>
      </div>
